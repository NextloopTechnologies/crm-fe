...
const routeMeta: Record<string, { title: string; breadcrumb: string[] }> = {
  ...
  "/partners": { title: "Partners & Vendors", breadcrumb: ["Manage staffing partners and vendors"] },
  "/partners/create": { title: "Partners & Vendors", breadcrumb: ["Partners & Vendors", "Add"] },
  "/partners/edit/:id": { title: "Partners & Vendors", breadcrumb: ["Partners & Vendors", "Edit"] },
