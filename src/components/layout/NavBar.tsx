...
const routeMeta: Record<string, { title: string; breadcrumb: string[] }> = {
  ...
  "/vendors": { title: "Vendors", breadcrumb: ["Manage staffing vendors who share candidate profiles"] },
  "/vendors/create": { title: "Vendors", breadcrumb: ["Vendors", "Add Vendor"] },
  "/vendors/edit/:id": { title: "Vendors", breadcrumb: ["Vendors", "Edit Vendor"] },
